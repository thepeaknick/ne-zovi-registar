...
/// <param name="UserAccountGuidId">Guid Id korisničog naloga korisnika registra</param>
...
public record LoginResultDto(Guid RegUserId, Guid UserAccountGuidId, string AccessToken, DateTime AccessTokenExpTime, string RefreshToken, DateTime RefreshTokenExpTime);