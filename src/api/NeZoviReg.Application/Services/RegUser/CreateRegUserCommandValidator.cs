...
public class CreateRegUserCommandValidator : AbstractValidator<CreateRegUserCommand>
{
    ...
    {
        RuleFor(x => x.Name)
            .NotEmpty<CreateRegUserCommand, string, RegUserDto>(Name.Empty.Message)
            .MaximumLength<CreateRegUserCommand, RegUserDto>(Domain.Model.Domain.RegUser.NameMaxLength, Name.TooLong.Message);
