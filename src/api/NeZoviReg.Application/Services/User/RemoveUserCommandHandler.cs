...
internal sealed class RemoveUserCommandHandler : ICommandHandler<RemoveUserCommand, string>
{
    ...
    public async Task<Result<string>> Handle(RemoveUserCommand request, CancellationToken cancellationToken)
    {
