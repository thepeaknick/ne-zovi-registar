...
public abstract class EnumerationEntity<TEnum> : IEquatable<EnumerationEntity<TEnum>>, IEntity
    where TEnum : EnumerationEntity<TEnum>
{
    ...
    public static bool operator !=(EnumerationEntity<TEnum> a, EnumerationEntity<TEnum> b) => !(a == b);
    ...
    /// <inheritdoc />
    public virtual bool Equals(EnumerationEntity<TEnum>? other)
    {
        if (other is null)
        {
            return false;
    ...
    public override bool Equals(object? obj)
    {
        ...
        return obj is EnumerationEntity<TEnum> otherValue && otherValue.Id.Equals(Id);
    }
